...
export function addMapLayers(map: mapboxgl.Map): void {
  ...
  if (map.getSource("india") && !map.getLayer("india-line")) {
    map.addLayer({
      id: "india-line",
      type: "line",
      source: "india",
  ...
  if (map.getSource("karnataka") && !map.getLayer("karnataka-line")) {
    map.addLayer({
      id: "karnataka-line",
      type: "line",
      source: "karnataka",
  ...
  if (map.getSource("cities") && !map.getLayer("cities-fill")) {
    map.addLayer({
      id: "cities-fill",
      type: "fill",
      source: "cities",
  ...
  if (map.getSource("district-centers") && !map.getLayer("district-labels")) {
    map.addLayer({
      id: "district-labels",
      type: "symbol",
