...
function TooltipContent({
  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] [background:var(--tooltip-bg,var(--color-foreground))] fill-(--tooltip-bg,var(--color-foreground))" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  )
}
