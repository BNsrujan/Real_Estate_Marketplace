  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative h-6 flex items-center">
        ...
        <div className="absolute h-1 w-full rounded-none bg-muted" />

   
        <div
          className="absolute h-1 rounded-none bg-primary transition-all duration-150 ease-[cubic-bezier(0.2,0,0,1)]"
          style={{
            left: `${pct(minVal)}%`,
        ...
        <div
          className="pointer-events-none absolute top-1/2 h-5 w-5 -translate-x-1/2 -translate-y-1/2 rounded-none bg-primary shadow-md ring-2 ring-primary/30 transition-transform duration-150 ease-[cubic-bezier(0.2,0,0,1)]"
