...
export default function StartExploreButton({ onClick }: Props) {
  return (
    <div className="fixed bottom-[calc(4.5rem+env(safe-area-inset-bottom))] min-[390px]:bottom-[calc(5rem+env(safe-area-inset-bottom))] md:absolute md:bottom-12 left-1/2 z-20 flex w-full -translate-x-1/2 justify-center px-4 max-[389px]:[&>button]:py-2.5">
      <button
        onClick={onClick}
        className="
