    ...
    <div className="relative z-50 w-full flex flex-col md:flex-row justify-between md:items-center gap-2.5 md:gap-4 lg:h-24">
      ...
      <div className="relative w-[calc(100%-5rem)] max-w-full min-w-0 md:min-w-60 md:w-auto group">
        <input
          ...
          className={`w-full min-w-0 md:min-w-60 md:w-64 pl-10 pr-8 py-3 md:py-2.5 rounded-none bg-parchment/95 dark:bg-[#1C1B1F]/95 backdrop-blur-md border border-border/40 text-[#1C1B1F] dark:text-[#F5EFF7] placeholder:text-[#49454F] dark:placeholder:text-[#CAC4D0] caret-primary focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/60 text-sm shadow-sm md:shadow-none transition-all duration-200 ${MD3_EASE}`}
        />
        <Search
      ...
      <div className="flex w-full flex-wrap gap-2 md:mx-4 md:w-auto md:flex-nowrap md:justify-end justify-start">
        ...
        {activeDistrict && (
          <button
            ...
            className={`flex shrink-0 items-center gap-1.5 px-3 md:px-4 py-2.5 md:py-2 text-xs text-nowrap md:text-sm rounded-none backdrop-blur-md active:scale-95 transition-all duration-200 ${MD3_EASE} bg-primary text-primary-foreground shadow-sm `}
          >
            {activeDistrict}
            <X size={11} />
          </button>
        ...
        <button
          ...
          className={`shrink-0 px-3 md:px-4 py-2.5 md:py-2 text-xs text-nowrap md:text-sm rounded-none backdrop-blur-md active:scale-95 transition-all duration-200 ${MD3_EASE} ${
        ...
        {hasActiveFilters && (
          <button
            ...
            className={`shrink-0 px-3 py-2.5 md:py-2 text-xs text-nowrap rounded-none bg-background/70 backdrop-blur-md border border-border/30 text-muted-foreground hover:bg-background/90 hover:text-foreground active:scale-95 transition-all duration-200 ${MD3_EASE}`}
          >
            Clear all
          </button>
        )}
