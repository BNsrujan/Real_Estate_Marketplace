...
//         updateMarkerVisibility();
//       });
//       // ✅ NEW — toggle button visibility
//       const btn = document.querySelector(".start-btn") as HTMLElement;
//       if (btn) {
//         btn.style.opacity = map.getZoom() < 4 ? "1" : "0";
//         btn.style.pointerEvents = map.getZoom() < 4 ? "auto" : "none";
//       }

//       // ❌ rotation disabled safely
//       // rotateGlobe();
//     });
...
//       <StartExploreButton onClick={handleZoomToKarnataka} />
...
//         //   fontFamily: "Orbitron",
//         //   textShadow:
//         //     "0 0 20px rgba(108,207,255,0.6), 0 0 40px rgba(58,167,255,0.4)",
//         // }}
//         style={{
//           position: "absolute",
//           top: "20px",
//           width: "100%",
//           textAlign: "center",
//           fontSize: "clamp(48px, 8vw, 110px)", // bigger
//           fontWeight: "700",
//           letterSpacing: "14px",
//           color: "#e6f7ff",
//           zIndex: 0, // behind globe
//           fontFamily: "Orbitron, sans-serif",
